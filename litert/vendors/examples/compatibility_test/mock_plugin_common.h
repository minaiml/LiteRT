...
inline LiteRtStatus LITERT_API_CALL MockCompilerPluginDummy(
    LiteRtCompilerPlugin compiler_plugin) {
  return kLiteRtStatusOk;
}

// Extra function pointer signature for future V1.2 ABI extensions.
typedef LiteRtStatus(LITERT_API_CALL* MockPluginFutureExtensionT)(void);

inline LiteRtStatus LITERT_API_CALL MockPluginFutureExtension() {
  return kLiteRtStatusOk;
}
