...
TEST(CompilerPluginCompatibilityTest,
  ...
  std::string path =
      GetPluginPath("libLiteRtCompilerPlugin_OlderSupported.so");
...
TEST(CompilerPluginCompatibilityTest,
  ...
  auto plugin_res = CompilerPluginFriend::LoadPlugin(
      path, /*env=*/nullptr, /*options=*/nullptr);
...
TEST(CompilerPluginCompatibilityTest,
  ...
  std::string path =
      GetPluginPath("libLiteRtCompilerPlugin_NewerSupported.so");
  LITERT_ASSERT_OK_AND_ASSIGN(
      auto plugin, CompilerPluginFriend::LoadPlugin(path, /*env=*/nullptr,
                                              /*options=*/nullptr));
...
TEST(CompilerPluginCompatibilityTest,
  ...
  std::string path =
      GetPluginPath("libLiteRtCompilerPlugin_SameSupported.so");
  LITERT_ASSERT_OK_AND_ASSIGN(
      auto plugin, CompilerPluginFriend::LoadPlugin(path, /*env=*/nullptr,
                                              /*options=*/nullptr));
...
TEST(CompilerPluginCompatibilityTest,
  ...
  std::string path =
      GetPluginPath("libLiteRtCompilerPlugin_NullInterface.so");
  auto plugin_res = CompilerPluginFriend::LoadPlugin(
      path, /*env=*/nullptr, /*options=*/nullptr);
  EXPECT_FALSE(plugin_res.HasValue());
  EXPECT_EQ(plugin_res.Error().Status(), kLiteRtStatusErrorWrongVersion);
...
TEST(CompilerPluginCompatibilityTest,
  ...
  std::string path =
      GetPluginPath("libLiteRtCompilerPlugin_Incompatible.so");
  auto plugin_res = CompilerPluginFriend::LoadPlugin(
      path, /*env=*/nullptr, /*options=*/nullptr);
  EXPECT_FALSE(plugin_res.HasValue());
  EXPECT_EQ(plugin_res.Error().Status(), kLiteRtStatusErrorWrongVersion);
...
TEST(CompilerPluginCompatibilityTest,
     Scenario4b_CorruptedHeaderRejected) {
  std::string path =
